 ...
 *
 */
package com.mycompany.training.storefront.interceptors;
...
import com.mycompany.training.storefront.util.CSRFHandlerInterceptor;
import com.mycompany.training.storefront.util.CSRFTokenManager;
...
{
	private final String SESSION_CSRF_ATTRIBUTE = "com.mycompany.training.storefront.util.CSRFTokenManager.tokenval";
